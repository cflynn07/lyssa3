...
module.exports = (app) ->
  ...
  app.get config.apiSubDir + '/v1/businessDivision2s', (req, res) ->
    async.series [
      (callback) ->
        ...
        switch userType
          when 'superAdmin'
            ...
            params =
              method: 'findAll'
              find: {}
            apiExpand(req, res, businessDivision2, params)
  ...
  app.get config.apiSubDir + '/v1/businessDivision2s/:id', (req, res) ->
    async.series [
      (callback) ->
        apiAuth req, res, callback
      (callback) ->
